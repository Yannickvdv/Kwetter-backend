...
//
//        assertEquals(Arrays.asList(tweet1), this.userService.getUser(this.user1.getName()).getTweets());
//        assertEquals(Arrays.asList(tweet1), this.userService.getUser(this.user2.getName()).getMentions());

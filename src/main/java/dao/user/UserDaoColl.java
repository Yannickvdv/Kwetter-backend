...
public class UserDaoColl implements UserDao {
    ...
    /**
     * Add a follower to user's 'followers', and add the user to the follower
     * his 'following'
     *
    ...
    /**
     * Remove a follower of a user's 'followers', and remove the user of the
     * follower his 'following'
     *
